  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row d-flex justify-content-center my-4 mt-5">
        <div
          className="col-lg-9 col-md-12 col-12 rounded shadow px-5 py-4 privayPolicyCont"
          style={{ background: "#f0f0f075" , height : "90vh" , overflowY : "scroll" , overflowX : "hidden" }}
        >
              ...
              <div className="container">
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        <strong>Website</strong> refers to XperienceIt,
                        accessible from{" "}
                        <a
                          href="https://xperienceit.in/"
                          rel="external nofollow noopener"
                          target="_blank"
                        >
                          https://xperienceit.in/
                        </a>
                      </p>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      <p>
                        ...
                        <a
                          ...
                          data-cfemail="65060a0b1104061125001d1500170c000b06000c114b0c0b"
                        >
                          [email&nbsp;protected]
                        </a>
                      </p>
                    ...
                    <li>
                      <p>By phone number: +91 7080581133</p>
                    </li>
                  </ul>
                </div>
              </div>
