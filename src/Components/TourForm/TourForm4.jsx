      ...
      >
        <div className="tour2">
          ...
          <div className="tourPage2">
            ...
            <h4 style={{marginLeft:"5px" ,fontWeight:"400"}}>Is your travel date fixed</h4>
              <div className="input_box2">
                <input type="radio" name="trip" id="yes" />
              ...
              <div className="input_box2">
                <input type="radio" name="trip" id="no" />
